...
This script prepares transplant center spatial objects for access estimation. It standardizes center-level geometry and attributes so that organ-specific distance buffers and drive-time isochrones can be generated consistently across years and center categories.
